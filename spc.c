...
#define ALIEN1_11 "sssss"
#define ALIEN1_12 "iiiii"
#define ALIEN1_13 ";;;;;"
#define ALIEN1_21 "zzzzz"
#define ALIEN1_22 "iiiii"
#define ALIEN1_23 ";; ;;"
...
void move_nave_mae(t_lista *nave_mae){
	...
	if(lista_vazia(nave_mae)){
		...
		if(nave_mae->atual->pos.x + 6 > MIN_X)
...
int main() {
	...
	while(1){
		...
		score += remove_morto(&tiro, &aliens, &barreiras, &bombas, &nave_mae);
		mvprintw(0, 50, "%d", score);
		desenha_tiro(&tiro);
